...
The full model has an adj-R^2 of 0.69 on 77 predictor variables. In order to reduce our model, we ran a stepwise AIC.
...
```{r}
fun_augmented_fit <- lm(fun_o ~ . -attr_o -sinc_o -intel_o -dec_o -amb_o, data = na.omit(augmented_attribs))
