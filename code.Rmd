...
reduced_const_fit <- lm(dec_o ~  attr_o  + gender + age + career_c + tvsports + 
    art + yoga + fun_o, data = na.omit(const_attribs))

summary(reduced_const_fit)

# look at maybe removing career_c since it didn't improve our R^2 by much. F test shows it helps, so we keep it in model
anova(reduced_const_fit,lm(dec_o ~ fun_o + attr_o + gender + age + tvsports + 
